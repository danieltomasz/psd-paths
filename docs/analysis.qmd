...
Similarly to @mckeown2023TestretestReliabilitySpectral, we  excluded participants with specparam model fits < 0.9 R2 on more than 50% of the channels. Given the above criterium 4 subjects were identified as those to be exluded from analysis: `102 103 126 151`. (Check 139?)
